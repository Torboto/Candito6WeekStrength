...
class SetCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        //self.frame = CGRectOffset(self.myLabel.frame, 0, -20);

        let setWidth = (self.bounds.size.width / 4)
        print(setWidth)
        
        //self.set1.frame = CGRectMake(0, 0, setWidth, 25)
        //self.set2.frame = CGRectMake(setWidth, 0, setWidth, 25)
        //self.set3.frame = CGRectMake((setWidth * 2), 0, setWidth, 25)
        //self.set4.frame = CGRectMake((setWidth * 3), 0, setWidth, 25)
        //let views = [
        //    "set1": set1,
        //    "set2": set2,
        //    "set3": set3,
